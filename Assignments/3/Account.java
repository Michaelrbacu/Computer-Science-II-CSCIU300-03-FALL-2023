...
public class Account {
   ...
   * rand.nextInt(10)+10; this generate [0,19]; // this generate a number in the
   * range [0,19]
   * //nextInt(n) generates an int number in [0,n-1]
   * If you wants to generate an integer in range [low, high], have the Random
   * object calls nextInt() such as rand.nextInt(high – low + 1) + low;
   */
